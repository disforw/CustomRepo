 ...
 */
metadata {
	definition (name: "disforw - Opposite ZWave Switch", namespace: "", author: "disforw", ocfDeviceType: "oic.d.switch") {
		capability "Actuator"
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"switch", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
				attributeState "on", label: '${name}', action: "switch.off", icon: "st.switches.switch.on", backgroundColor: "#ffffff"
				attributeState "off", label: '${name}', action: "switch.on", icon: "st.switches.switch.off", backgroundColor: "#B82121"
			}
		}
